          ...
          <div class="col-md-12 mb-5">
            ...
            <div class="block-3 d-md-flex">
              ...
              <div class="text order-1">
                ...
                <div class="price"><sup>Rp</sup><span class="number">245k</span><sub>/per night</sub></div>
                <ul class="specs mb-5">
                  <li><strong>Adults:</strong> 1</li>
                  <li><strong>Categories:</strong> Single</li>
                  <li><strong>Facilities:</strong> Closet with hangers, HD flat-screen TV, Telephone</li>
        ...
        <div class="row">
          <div class="col-lg-4 mb-5">
            <div class="block-34">
              ...
              <div class="text">
                <h2 class="heading">Bachelor Room</h2>
                <div class="price"><sup>Rp</sup><span class="number">156k</span><sub>/per night</sub></div>
                <ul class="specs">
                  <li><strong>Adults:</strong> 1</li>
                  <li><strong>Categories:</strong> Single</li>
                  <li><strong>Facilities:</strong> Closet with hangers, HD flat-screen TV, Telephone</li>
          ...
          <div class="col-lg-4 mb-5">
            <div class="block-34">
              ...
              <div class="text">
                <h2 class="heading">Presidential Room</h2>
                <div class="price"><sup>Rp</sup><span class="number">375k</span><sub>/per night</sub></div>
                <ul class="specs">
                  <li><strong>Adults:</strong> 1</li>
                  <li><strong>Categories:</strong> Single</li>
                  <li><strong>Facilities:</strong> Closet with hangers, HD flat-screen TV, Telephone</li>
