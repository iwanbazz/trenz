...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="/">Trenz Hotel</a>
              ...
              <div class="nonloop-block-13 owl-carousel">
                  <div class="item">
                    <div class="block-34">
                      ...
                      <div class="text">
                        ...
                        <div class="price"><sup>Rp</sup><span class="number">150k</span><sub>/per night</sub></div>
                        <ul class="specs">
                  ...
                  <div class="item">
                    <div class="block-34">
                      ...
                      <div class="text">
                        ...
                        <div class="price"><sup>Rp</sup><span class="number">300k</span><sub>/per night</sub></div>
                        <ul class="specs">
                          <li><strong>Adults:</strong> 1</li>
                          <li><strong>Categories:</strong> Single</li>
                          <li><strong>Facilities:</strong> Closet with hangers, HD flat-screen TV, Telephone</li>
                  ...
                  <div class="item">
                    <div class="block-34">
                      ...
                      <div class="text">
                        ...
                        <div class="price"><sup>Rp</sup><span class="number">400k</span><sub>/per night</sub></div>
                        <ul class="specs">
                          <li><strong>Adults:</strong> 1</li>
                          <li><strong>Categories:</strong> Single</li>
                          <li><strong>Facilities:</strong> Closet with hangers, HD flat-screen TV, Telephone</li>
                  ...
                  <div class="item">
                    <div class="block-34">
                      ...
                      <div class="text">
                        ...
                        <div class="price"><sup>Rp</sup><span class="number">450k</span><sub>/per night</sub></div>
                        <ul class="specs">
                          <li><strong>Adults:</strong> 1</li>
                          <li><strong>Categories:</strong> Single</li>
                          <li><strong>Facilities:</strong> Closet with hangers, HD flat-screen TV, Telephone</li>
                  ...
                  <div class="item">
                    <div class="block-34">
                      ...
                      <div class="text">
                        ...
                        <div class="price"><sup>Rp</sup><span class="number">800k</span><sub>/per night</sub></div>
                        <ul class="specs">
                          <li><strong>Adults:</strong> 1</li>
                          <li><strong>Categories:</strong> Single</li>
                          <li><strong>Facilities:</strong> Closet with hangers, HD flat-screen TV, Telephone</li>
                  ...
                  <div class="item">
                    <div class="block-34">
                      ...
                      <div class="text">
                        <h2 class="heading">VIP Room</h2>
                        <div class="price"><sup>Rp</sup><span class="number">1200k</span><sub>/per night</sub></div>
                        <ul class="specs">
                          <li><strong>Adults:</strong> 1</li>
                          <li><strong>Categories:</strong> Single</li>
                          <li><strong>Facilities:</strong> Closet with hangers, HD flat-screen TV, Telephone</li>
                    ...
                    <div class="item">
                      <div class="block-34">
                        ...
                        <div class="text">
                          ...
                          <div class="price"><sup>Rp</sup><span class="number">30k</span></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="item">
                      <div class="block-34">
                        ...
                        <div class="text">
                          ...
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione quo vel aut ab qui quas!</p>
                          <div class="price"><sup>Rp</sup><span class="number">45k</span></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="item">
                      <div class="block-34">
                        ...
                        <div class="text">
                          ...
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione quo vel aut ab qui quas!</p>
                          <div class="price"><sup>Rp</sup><span class="number">75k</span></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="item">
                      <div class="block-34">
                        ...
                        <div class="text">
                          ...
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione quo vel aut ab qui quas!</p>
                          <div class="price"><sup>Rp</sup><span class="number">25k</span></div>
                        </div>
                      </div>
                    </div>
        ...
        <div class="col-md-6 col-lg-4">
          ...
          <div class="block-21 d-flex mb-4">
            ...
            <div class="text">
              ...
              <div class="meta">
                ...
                <div><a href="#"><span class="icon-chat"></span> 45</a></div>
              </div>
            </div>
          </div>
          ...
          <div class="block-21 d-flex mb-4">
            ...
            <div class="text">
              <h3 class="heading"><a href="#">Our Luxury Hotel &amp; Restaurants</a></h3>
              <div class="meta">
                <div><a href="#"><span class="icon-calendar"></span> May 29, 2019</a></div>
                <div><a href="#"><span class="icon-person"></span> Admin</a></div>
                <div><a href="#"><span class="icon-chat"></span> 18</a></div>
              </div>
            </div>
          </div>
          ...
          <div class="block-21 d-flex mb-4">
            ...
            <div class="text">
              <h3 class="heading"><a href="#">Our Luxury Hotel &amp; Restaurants</a></h3>
              <div class="meta">
                <div><a href="#"><span class="icon-calendar"></span> Jan 23, 2019</a></div>
                <div><a href="#"><span class="icon-person"></span> Admin</a></div>
                <div><a href="#"><span class="icon-chat"></span> 37</a></div>
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4">
          <div class="block-23">
            <h3 class="heading-section">Contact Info</h3>
              <ul>
                <li><span class="icon icon-map-marker"></span><span class="text">Jl. HR. Soebrantas Panam No.228, Tobekgodang, Kec. Tampan, Kota Pekanbaru, Riau 28289</span></li>
                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+62852-7467-7681</span></a></li>
                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@trenzhotel.com</span></a></li>
